...
My proposal includes (1) a specification of an exchange format (the Offering), (2) a framework for the identification of Offerings (which overcomes some problems in W3C's URIs/URNs), and (3) a metadata 
mapping library ("vocab. library" in the figure below).

Below is a conceptual diagram of the data architecture I propose: *The Basin Network Model*.
