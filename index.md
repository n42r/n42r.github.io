...
I combine two strength clusters (which can make me hard to profile):
...
I'm comfortable at working with distributed architectures, modular monoliths, and HTTP API interfaces. My technical proficiencies include Python, Flask, WSGI, Apache, Docker (Multi-container), MongoDB, Neo4j, MySQL, Google Firebase, and RDF/Semantic Data. And formerly Java, C++, and LISP.
